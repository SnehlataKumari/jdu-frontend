...
@Component({
  selector: 'app-manage-speeches',
  templateUrl: './manage-speeches.component.html',
  styleUrls: ['./manage-speeches.component.scss']
})
export class ManageSpeechesComponent implements OnInit {

  @Input() resourceUrl: string = '/speeches';
